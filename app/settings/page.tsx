            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input value={settings.farmerId} disabled className="bg-muted" />
                  <p className="text-sm text-muted-foreground">Farmer ID cannot be changed after login</p>
                </div>

                {settings.lastSync && (
                  <div className="space-y-2">
                    <Label>Last Sync</Label>
                    <Input value={new Date(settings.lastSync).toLocaleString()} disabled className="bg-muted" />
                  </div>
                )}
              </CardContent>
            </Card>
