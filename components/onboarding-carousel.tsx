        ...
        <CardContent className="p-8">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-balance">{currentStepData.title}</h2>
              <p className="text-muted-foreground text-balance leading-relaxed">{currentStepData.description}</p>
            </div>
